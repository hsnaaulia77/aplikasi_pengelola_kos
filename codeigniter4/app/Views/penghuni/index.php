...
<body>
    <div class="container">
        ...
        <div class="header-flex">
            <img src="https://img.icons8.com/color/96/000000/user-group-man-man.png" alt="Logo Penghuni" class="logo">
            <h1>Data Penghuni</h1>
        </div>
        <div class="top-bar">
            <input type="text" id="searchInput" class="search-bar" placeholder="Cari penghuni..." onkeyup="searchTable()">
            <a href="/penghuni/create" class="btn-tambah">+ Tambah Penghuni</a>
        </div>
        <table id="penghuniTable">
            ...
            <tr>
                ...
                <td class="aksi">
                    <a href="/penghuni/edit/<?= $p['id'] ?>" class="aksi-btn" title="Edit">
                    ...
                    <a href="/penghuni/delete/<?= $p['id'] ?>" class="aksi-btn" title="Hapus" onclick="return confirm('Yakin hapus?')">
    ...
    function searchTable() {
        ...
        var table = document.getElementById('penghuniTable');
