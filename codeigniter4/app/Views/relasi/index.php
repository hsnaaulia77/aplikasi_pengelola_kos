...
<body>
    <div class="container">
        ...
        <div class="header-flex">
            <img src="https://img.icons8.com/color/96/000000/room.png" alt="Logo Relasi" class="logo">
            <h1>Data Relasi Penghuni & Kamar</h1>
        </div>
        <div class="top-bar">
            <input type="text" id="searchInput" class="search-bar" placeholder="Cari relasi..." onkeyup="searchTable()">
            <a href="/relasi/create" class="btn-tambah">+ Tambah Relasi</a>
        </div>
        <table id="relasiTable">
            ...
            <tr>
                ...
                <td class="aksi">
                    <a href="/relasi/edit/<?= $r['id'] ?>" class="aksi-btn" title="Edit">
                    ...
                    <a href="/relasi/delete/<?= $r['id'] ?>" class="aksi-btn" title="Hapus" onclick="return confirm('Yakin hapus?')">
    ...
    function searchTable() {
        ...
        var table = document.getElementById('relasiTable');
