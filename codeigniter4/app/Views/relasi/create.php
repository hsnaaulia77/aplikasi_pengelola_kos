...
<body>
    <div class="container">
        ...
        <form method="post" action="/relasi/store" autocomplete="off" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <input type="date" id="tgl_masuk" name="tgl_masuk" required aria-label="Tanggal Masuk">
                <div class="error" id="err-masuk" style="display:none;">Tanggal masuk wajib diisi</div>
            </div>
            <div class="form-group">
                <label for="tgl_keluar">Tgl Keluar</label>
                <input type="date" id="tgl_keluar" name="tgl_keluar" aria-label="Tanggal Keluar">
            </div>
