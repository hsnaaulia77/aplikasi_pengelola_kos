...
<body>
    <div class="container">
        ...
        <h1>Edit Tagihan</h1>
        <div class="notif-success" id="notifSuccess">Tagihan berhasil diupdate!</div>
        <form id="formTagihan" method="post" action="/tagihan/update/<?= $tagihan['id'] ?>" autocomplete="off" onsubmit="return handleSubmit(event)">
            <label for="bulan">Bulan</label>
            <input type="month" id="bulan" name="bulan" value="<?= esc($tagihan['bulan']) ?>" required autofocus>
            ...
            <input type="number" id="jml_tagihan" name="jml_tagihan" value="<?= esc($tagihan['jml_tagihan']) ?>" placeholder="Masukkan jumlah tagihan" min="0" required>
