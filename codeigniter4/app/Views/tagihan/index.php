...
<body>
    <div class="container">
        ...
        <div class="header-flex">
            <img src="https://img.icons8.com/color/96/000000/invoice.png" alt="Logo Tagihan" class="logo">
            <h1>Data Tagihan</h1>
        </div>
        <div class="top-bar">
            <input type="text" id="searchInput" class="search-bar" placeholder="Cari tagihan..." onkeyup="searchTable()">
            <a href="/tagihan/create" class="btn-tambah">+ Tambah Tagihan</a>
        </div>
        <table id="tagihanTable">
            ...
            <tr>
                ...
                <td class="aksi">
                    <a href="/tagihan/edit/<?= $t['id'] ?>" class="aksi-btn" title="Edit">
                    ...
                    <a href="/tagihan/delete/<?= $t['id'] ?>" class="aksi-btn" title="Hapus" onclick="return confirm('Yakin hapus?')">
    ...
    function searchTable() {
        ...
        var table = document.getElementById('tagihanTable');
