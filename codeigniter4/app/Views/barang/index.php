...
<body>
    <div class="container">
        ...
        <div class="header-flex">
            <img src="https://img.icons8.com/color/96/000000/box--v2.png" alt="Logo Barang" class="logo">
            <h1>Data Barang</h1>
        </div>
        <div class="top-bar">
            <input type="text" id="searchInput" class="search-bar" placeholder="Cari barang..." onkeyup="searchTable()">
        ...
        <table id="barangTable">
            ...
            <tr>
                ...
                <td><?= esc($b['harga']) ?></td>
                <td class="aksi">
                    <a href="/barang/edit/<?= $b['id'] ?>" class="aksi-btn" title="Edit">
                    ...
                    <a href="/barang/delete/<?= $b['id'] ?>" class="aksi-btn" title="Hapus" onclick="return confirm('Yakin hapus?')">
