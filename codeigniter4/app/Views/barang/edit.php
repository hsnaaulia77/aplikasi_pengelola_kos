...
<body>
    <div class="container">
        ...
        <h1>Edit Barang</h1>
        <form method="post" action="/barang/update/<?= $barang['id'] ?>" autocomplete="off" onsubmit="return validateForm()">
            <div class="form-group">
                <label for="nama">Nama</label>
                <input type="text" id="nama" name="nama" value="<?= esc($barang['nama']) ?>" required placeholder="Masukkan nama barang" autofocus aria-label="Nama Barang">
                <div class="error" id="err-nama" style="display:none;">Nama wajib diisi</div>
            </div>
            <div class="form-group">
                <label for="harga">Harga</label>
                <input type="number" id="harga" name="harga" value="<?= esc($barang['harga']) ?>" required min="0" step="1000" placeholder="Masukkan harga (Rp)" aria-label="Harga Barang">
        ...
        <a href="/barang" class="back-link">&larr; Kembali</a>
    </div>
    <script>
    // Dark Mode Toggle
