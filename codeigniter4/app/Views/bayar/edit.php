...
<body>
    <div class="container">
        ...
        <form method="post" action="/bayar/update/<?= $bayar['id'] ?>" autocomplete="off" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <input type="number" id="jml_bayar" name="jml_bayar" value="<?= esc($bayar['jml_bayar']) ?>" required min="0" step="1000" placeholder="Masukkan jumlah bayar (Rp)" aria-label="Jumlah Bayar">
