...
<body>
    <div class="container">
        ...
        <div class="header-flex">
            <img src="https://img.icons8.com/color/96/000000/cash-in-hand.png" alt="Logo Bayar" class="logo">
            <h1>Data Pembayaran</h1>
        </div>
        <div class="top-bar">
            <input type="text" id="searchInput" class="search-bar" placeholder="Cari pembayaran..." onkeyup="searchTable()">
            <a href="/bayar/create" class="btn-tambah">+ Tambah Pembayaran</a>
        </div>
        <table id="bayarTable">
            <tr>
                <th>Bulan Tagihan</th>
            ...
            <tr>
                ...
                <td><?= esc($b['status']) ?></td>
                <td class="aksi">
                    <a href="/bayar/edit/<?= $b['id'] ?>" class="aksi-btn" title="Edit">
                    ...
                    <a href="/bayar/delete/<?= $b['id'] ?>" class="aksi-btn" title="Hapus" onclick="return confirm('Yakin hapus?')">
    ...
    function searchTable() {
        ...
        var table = document.getElementById('bayarTable');
